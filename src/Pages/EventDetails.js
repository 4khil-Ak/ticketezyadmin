            ...
            <div className="row">
              ...
              <div className="col-md-3">
                <div className="d-flex flex-column">
                  ...
                  <p className="p-1 pt-0 pl-3 text-capitalize">
                    {data.language}
                  </p>
                </div>
              </div>
              <div className="col-md-3">
                <div className="d-flex flex-column">
                  ...
                  <p className="p-1 pt-0 pl-3">{data.duration}&nbsp;Mins</p>
                </div>
              </div>
              <div className="col-md-3">
                <div className="d-flex flex-column">
                  ...
                  <p className="p-1 pt-0 pl-3 text-capitalize">
                    {data.categories.map((i, index) => {
                      return (
                        <span key={index}>
                          <span className="text-capitalize">{i}</span>
                          <span>,&ensp;</span>
                        </span>
                      );
                    })}
              ...
              <div className="col-md-12">
                <div className="d-flex flex-column">
                  ...
                  <p className="p-1 pt-0 pl-3">
                    {data.cast_and_crew !== null &&
                      data.cast_and_crew.map((data,index) => {
                        return (
                          <span key={index}>
