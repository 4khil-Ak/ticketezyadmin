        ...
        <div className="card box-shadow p-2">
          ...
          <div className="pb-2">
            ...
            <p className="location">
              Location: <b>{props.details.location}</b>
            </p>
            <p className="venue">
              Venue: <b>{props.details.venue}</b>
            </p>
            <p className="duration">
              Duration: <b>{props.details.duration}&nbsp;Mins</b>
            </p>
          </div>
          <div className="card-footer bg-transparent row py-2">
            <Link
              className="footer-icon fas fa-eye text-primary"
              to={`/eventdetails/${props.details.secret}`}
              key={props.details.secret}
            ></Link>
            <i
